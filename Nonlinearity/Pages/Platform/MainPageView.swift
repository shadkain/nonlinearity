...
class MainPageView: UIViewController {
    ...
    func setConstraint() {
        ...
        NSLayoutConstraint.activate([
             ...
             additionalSpace.heightAnchor.constraint(equalToConstant: 50),
        ])
        ...
        NSLayoutConstraint.activate([
             bubbleAdapter.collectionView!.topAnchor.constraint(equalTo: tabAdapter.collectionView!.bottomAnchor, constant: 5),
